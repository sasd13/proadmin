...
INSERT INTO userpreferences(_value,_user,_preference)
	SELECT prf._defaultvalue, usr._id, prf._id
	FROM users usr, preferences prf
	WHERE usr._uid = '6b86b273ff34fce19d6b804eff5a3f5747ada4eaa22f1d49c01e52ddb7875b4b' AND prf._category = 'GEN' AND prf._name = 'DT';

INSERT INTO userpreferences(_value,_user,_preference)
	SELECT prf._defaultvalue, usr._id, prf._id
	FROM users usr, preferences prf
	WHERE usr._uid = '8f4252a81803b4a7a8eeac961735a3e270ba092d28aac4ef9aa1f376684c33b1' AND prf._category = 'GEN' AND prf._name = 'DT';
