...
import com.sasd13.proadmin.android.service.v2.IRunningTeamService;
import com.sasd13.proadmin.android.util.adapter.bean2itf.v2.RunningTeamAdapterB2I;
import com.sasd13.proadmin.android.util.adapter.itf2bean.v2.AcademicLevelAdapterI2B;
import com.sasd13.proadmin.android.util.adapter.itf2bean.v2.RunningAdapterI2B;
import com.sasd13.proadmin.android.util.adapter.itf2bean.v2.RunningTeamAdapterI2B;
import com.sasd13.proadmin.android.util.adapter.itf2bean.v2.TeamAdapterI2B;
...
public class RunningTeamService implements IRunningTeamService {
    ...
    public ServiceResult<List<RunningTeam>> read(Map<String, String[]> parameters) {
        Promise promise = new Promise("GET", Resources.URL_BACKEND_RUNNINGTEAMS, RunningTeamResponseBean.class);
    ...
    public ServiceResult<Map<String, Object>> retrieve(Map<String, Map<String, String[]>> allParameters) {
        ...
        requests[0] = new MultiReadPromise.Request(PARAMATERS_RUNNING, Resources.URL_BACKEND_RUNNINGS, RunningResponseBean.class);
        requests[0].setParameters(allParameters.get(PARAMATERS_RUNNING));

        requests[1] = new MultiReadPromise.Request(PARAMETERS_TEAM, Resources.URL_BACKEND_TEAMS, TeamResponseBean.class);
        requests[1].setParameters(allParameters.get(PARAMETERS_TEAM));

        requests[2] = new MultiReadPromise.Request(PARAMETERS_ACADEMICLEVEL, Resources.URL_BACKEND_ACADEMICLEVELS, AcademicLevelResponseBean.class);
    ...
    public ServiceResult<Void> create(RunningTeam runningTeam) {
        Promise promise = new Promise("POST", Resources.URL_BACKEND_RUNNINGTEAMS);
    ...
    public ServiceResult<Void> update(RunningTeam runningTeam) {
        Promise promise = new Promise("PUT", Resources.URL_BACKEND_RUNNINGTEAMS);
    ...
    public ServiceResult<Void> delete(List<RunningTeam> runningTeams) {
        Promise promise = new Promise("DELETE", Resources.URL_BACKEND_RUNNINGTEAMS);
