...
import com.sasd13.proadmin.android.util.adapter.itf2bean.v1.ProjectAdapterI2B;
...
public class ProjectService implements IProjectService {
    ...
    public ServiceResult<List<Project>> readAll() {
        Promise promise = new Promise("GET", Resources.URL_WS_PROJECTS, ProjectResponseBean.class);
