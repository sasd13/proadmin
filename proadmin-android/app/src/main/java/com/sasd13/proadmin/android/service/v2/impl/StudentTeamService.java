...
import com.sasd13.proadmin.android.service.v2.IStudentTeamService;
import com.sasd13.proadmin.android.util.adapter.bean2itf.v2.StudentTeamAdapterB2I;
...
public class StudentTeamService implements IStudentTeamService {
    ...
    public ServiceResult<List<StudentTeam>> read(Map<String, String[]> parameters) {
        Promise promise = new Promise("GET", Resources.URL_BACKEND_STUDENTTEAMS, StudentTeamResponseBean.class);
    ...
    public ServiceResult<Void> create(StudentTeam studentTeam) {
        Promise promise = new Promise("POST", Resources.URL_BACKEND_STUDENTTEAMS);
    ...
    public ServiceResult<Void> delete(List<StudentTeam> studentTeams) {
        Promise promise = new Promise("DELETE", Resources.URL_BACKEND_STUDENTTEAMS);
