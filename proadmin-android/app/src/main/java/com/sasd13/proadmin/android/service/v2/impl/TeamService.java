...
import com.sasd13.proadmin.android.service.v2.ITeamService;
import com.sasd13.proadmin.android.util.adapter.bean2itf.v2.TeamAdapterB2I;
...
public class TeamService implements ITeamService {
    ...
    public ServiceResult<List<Team>> read(Map<String, String[]> parameters) {
        Promise promise = new Promise("GET", Resources.URL_BACKEND_TEAMS, TeamResponseBean.class);
    ...
    public ServiceResult<Void> create(Team team) {
        Promise promise = new Promise("POST", Resources.URL_BACKEND_TEAMS);
    ...
    public ServiceResult<Void> update(Team team) {
        Promise promise = new Promise("PUT", Resources.URL_BACKEND_TEAMS);
    ...
    public ServiceResult<Void> delete(List<Team> teams) {
        Promise promise = new Promise("DELETE", Resources.URL_BACKEND_TEAMS);
