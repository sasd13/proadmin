...
public class ProjectPagerFragmentFactory implements IPagerFragmentFactory {
    ...
    private static final @StringRes int[] TITLES_RES = {R.string.title_information, R.string.title_runnings};
    ...
    public Fragment make(int position) {
        switch (position) {
            case 0:
                return ProjectDescriptorFragment.newInstance(project);
            case 1:
                return ProjectRunningsFragment.newInstance(project);
            default:
                return null;
        }
    }
