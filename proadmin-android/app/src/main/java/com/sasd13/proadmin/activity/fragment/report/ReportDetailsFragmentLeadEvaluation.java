...
public class ReportDetailsFragmentLeadEvaluation extends Fragment implements IReadServiceCaller<IReadWrapper<Report>> {
    ...
    public static ReportDetailsFragmentLeadEvaluation newInstance(RunningTeam runningTeam) {
