...
public class TeamNewFragment extends Fragment implements IReadServiceCaller<List<Project>>, IManageServiceCaller<Running> {
    ...
    public static TeamNewFragment newInstance(Project project) {
