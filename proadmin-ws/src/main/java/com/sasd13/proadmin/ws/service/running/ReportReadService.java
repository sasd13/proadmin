...
public class ReportReadService implements IReadService<Report>, IDeepReadService<Report> {

	private static final Logger LOGGER = Logger.getLogger(ReportReadService.class);
