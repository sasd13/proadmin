...
public class AcademicLevelsServlet extends BeansServlet {

	private static final long serialVersionUID = -5517780261514018166L;

	private static final Logger LOGGER = Logger.getLogger(AcademicLevelsServlet.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		LOGGER.info("[Proadmin-WS] AcademicLevel : GET");
