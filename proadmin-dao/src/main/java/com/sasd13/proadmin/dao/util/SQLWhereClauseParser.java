...
public class SQLWhereClauseParser {
	...
	private static String fromTeacher(String key, String value) throws SQLWhereClauseException {
		if (Parameter.ID.getName().equalsIgnoreCase(key)) {
			try {
				return TeacherDAO.COLUMN_ID + " = " + Long.parseLong(value);
			} catch (NumberFormatException e) {
				throw new SQLWhereClauseException("Teacher key '" + key + "' parameter parsing error");
			}
			...
			throw new SQLWhereClauseException("Teacher key '" + key + "' is not a declared parameter");
		}
	}
	
	private static String fromProject(String key, String value) throws SQLWhereClauseException {
		if (Parameter.ID.getName().equalsIgnoreCase(key)) {
			try {
				return ProjectDAO.COLUMN_ID + " = " + Long.parseLong(value);
			} catch (NumberFormatException e) {
				throw new SQLWhereClauseException("Project key '" + key + "' parameter parsing error");
			}
			...
			throw new SQLWhereClauseException("Project key '" + key + "' is not a declared parameter");
		}
	}
	
	private static String fromStudent(String key, String value) throws SQLWhereClauseException {
		if (Parameter.ID.getName().equalsIgnoreCase(key)) {
			try {
				return StudentDAO.COLUMN_ID + " = " + Long.parseLong(value);
			} catch (NumberFormatException e) {
				throw new SQLWhereClauseException("Student key '" + key + "' parameter parsing error");
			}
		} else if (Parameter.NUMBER.getName().equalsIgnoreCase(key)) {
			...
			throw new SQLWhereClauseException("Student key '" + key + "' is not a declared parameter");
		}
	}
	
	private static String fromTeam(String key, String value) throws SQLWhereClauseException {
		if (Parameter.ID.getName().equalsIgnoreCase(key)) {
			try {
				return TeamDAO.COLUMN_ID + " = " + Long.parseLong(value);
			} catch (NumberFormatException e) {
				throw new SQLWhereClauseException("Team key '" + key + "' parameter parsing error");
			}
		} else if (Parameter.CODE.getName().equalsIgnoreCase(key)) {
			return TeamDAO.COLUMN_CODE + " = '" + value + "'";
		} else {
			throw new SQLWhereClauseException("Team key '" + key + "' is not a declared parameter");
		}
	}
	
	private static String fromStudentTeam(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("StudentTeam key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("StudentTeam key '" + key + "' parameter parsing error");
		}
	}
	
	private static String fromRunning(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("Running key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("Running key '" + key + "' parameter parsing error");
		}
	}
	
	private static String fromRunningTeam(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("RunningTeam key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("RunningTeam key '" + key + "' parameter parsing error");
		}
	}
	
	private static String fromReport(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("Report key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("Report key '" + key + "' parameter parsing error");
		}
	}
	
	private static String fromLeadEvaluation(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("LeadEvaluation key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("LeadEvaluation key '" + key + "' parameter parsing error");
		}
	}
	
	private static String fromIndividualEvaluation(String key, String value) throws SQLWhereClauseException {
		try {
			if (Parameter.ID.getName().equalsIgnoreCase(key)) {
				...
				throw new SQLWhereClauseException("IndividualEvaluation key '" + key + "' is not a declared parameter");
			}
		} catch (NumberFormatException e) {
			throw new SQLWhereClauseException("IndividualEvaluation key '" + key + "' parameter parsing error");
		}
	}
}
